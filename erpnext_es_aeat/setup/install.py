...
BOE_CONFIGS = [
    {
        ...
        "record_length": 0,
        "lines": [
            _line(110, "Tipo registro", "fixed", 1, fixed_value="<"),
            _line(120, "Modelo", "fixed", 3, fixed_value="303"),
            _line(130, "Ejercicio", "integer", 4, "year"),
            _line(140, "Periodo", "alphanumeric", 2, "period_type"),
            _line(150, "Cuota devengada (27)", "float", 17, "casilla_27", apply_sign=1),
            _line(160, "Cuota deducible (45)", "float", 17, "casilla_45", apply_sign=1),
            _line(170, "Resultado régimen general (46)", "float", 17, "casilla_46", apply_sign=1),
            _line(180, "Resultado liquidación (71)", "float", 17, "casilla_71", apply_sign=1),
        ],
    },
    {
